...
export function Pricing() {
  ...
  return (
    <div className="flex flex-col items-center w-full pt-[88px] md:pt-[160px] pb-16 md:pb-32 bg-black">
      <div className="max-w-[1240px] w-full mx-auto px-4 md:px-12 flex flex-col items-center">
        ...
        <div className="flex flex-col items-center gap-2 md:gap-4 mb-8 md:mb-16">
          <div className="relative flex items-center bg-zinc-800 rounded-full p-1 h-10 md:h-12 w-fit">
            <button 
              onClick={() => setBillingInterval("yearly")}
              className={`relative z-10 px-5 md:px-6 py-1.5 md:py-2 rounded-full text-[13px] md:text-[15px] font-semibold transition-[color,transform] active:scale-[0.96] ${billingInterval === "yearly" ? "text-white" : "text-gray-500"}`}
            >
              Yearly
            </button>
            <button 
              onClick={() => setBillingInterval("quarterly")}
              className={`relative z-10 px-5 md:px-6 py-1.5 md:py-2 rounded-full text-[13px] md:text-[15px] font-semibold transition-[color,transform] active:scale-[0.96] ${billingInterval === "quarterly" ? "text-white" : "text-gray-500"}`}
            >
              Quarterly
            </button>
            <motion.div 
              className="absolute top-1 left-1 bottom-1 w-[calc(50%-4px)] bg-black rounded-full shadow-sm z-0"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 w-full max-w-[800px] mb-10 md:mb-32">
          {/* Pro Card */}
          <div className="flex flex-col p-5 md:p-8 rounded-2xl md:rounded-3xl bg-zinc-900 border border-white/10 gap-4 md:gap-6">
            <div>
            ...
            <button className="w-full bg-white hover:bg-neutral-200 text-black rounded-full h-12 font-semibold transition-[background-color,transform] active:scale-[0.96]">
              Get started
            </button>
          ...
          {/* Team Card */}
          <div className="flex flex-col p-5 md:p-8 rounded-2xl md:rounded-3xl bg-black border border-white/10 gap-4 md:gap-6">
            <div>
              <div className="flex items-center gap-2 mb-1">
        ...
        <div className="flex flex-col md:flex-row gap-6 md:gap-24 w-full max-w-[800px] mb-10 md:mb-32 justify-center">
           <div className="flex flex-col items-center gap-2 text-center flex-1">
              ...
              <a href="#" className="text-[15px] font-semibold text-gray-300 underline mt-2 hover:text-white transition-colors">Contact Sales</a>
           </div>
           <div className="flex flex-col items-center gap-2 text-center flex-1">
              <div className="w-12 h-12 rounded-xl bg-[#27272a] flex items-center justify-center mb-2">
              ...
              <a href="#" className="text-[15px] font-semibold text-gray-300 underline mt-2 hover:text-white transition-colors">Read more</a>
           </div>
        </div>
             ...
             <table className="w-full text-left border-collapse">
               <thead>
                 <tr>
                   ...
                   <th className="w-1/5 p-4 text-[17px] font-bold text-white border-b border-white/10 bg-zinc-900 rounded-t-2xl">Pro</th>
               ...
               <tbody>
                 <tr className="border-b border-white/10">
                   ...
                   <td className="p-4 bg-zinc-900 text-white"><CheckIcon /></td>
                 ...
                 <tr className="border-b border-white/10">
                   ...
                   <td className="p-4 bg-zinc-900 text-[15px] text-white">Unlimited</td>
        ...
        <div className="w-full max-w-[800px] mb-12">
          ...
          <div className="flex flex-col gap-4">
            {faqs.map((faq, i) => {
              ...
              return (
                <div key={i} className="bg-zinc-900 hover:bg-zinc-800 transition-colors rounded-2xl cursor-pointer flex flex-col group overflow-hidden border border-white/10" onClick={() => setIsOpen(!isOpen)}>
