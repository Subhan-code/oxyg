...
export function Pricing() {
  ...
  return (
    <div className="flex flex-col items-center w-full pt-[88px] md:pt-[160px] pb-16 md:pb-32 bg-white">
      <div className="max-w-[1240px] w-full mx-auto px-4 md:px-12 flex flex-col items-center">
        
        {/* Header */}
        <div className="text-center mb-8 md:mb-16">
          <h1 className="text-[28px] leading-tight sm:text-5xl md:text-7xl font-bold tracking-tight text-black mb-3 md:mb-6 text-balance">
        ...
        <div className="flex flex-col items-center gap-2 md:gap-4 mb-8 md:mb-16">
          <div className="relative flex items-center bg-neutral-100 rounded-full p-1 h-10 md:h-12 w-fit">
            <button 
              onClick={() => setBillingInterval("yearly")}
              className={`relative z-10 px-5 md:px-6 py-1.5 md:py-2 rounded-full text-[13px] md:text-[15px] font-semibold transition-[color,transform] active:scale-[0.96] ${billingInterval === "yearly" ? "text-black" : "text-gray-500"}`}
            >
              Yearly
            </button>
            <button 
              onClick={() => setBillingInterval("quarterly")}
              className={`relative z-10 px-5 md:px-6 py-1.5 md:py-2 rounded-full text-[13px] md:text-[15px] font-semibold transition-[color,transform] active:scale-[0.96] ${billingInterval === "quarterly" ? "text-black" : "text-gray-500"}`}
            >
              Quarterly
            </button>
            <motion.div 
              className="absolute top-1 left-1 bottom-1 w-[calc(50%-4px)] bg-white rounded-full shadow-sm z-0"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 w-full max-w-[800px] mb-10 md:mb-32">
          {/* Pro Card */}
          <div className="flex flex-col p-5 md:p-8 rounded-2xl md:rounded-3xl bg-neutral-50 border border-black/5 gap-4 md:gap-6">
            <div>
            ...
            <div className="flex gap-2 items-center">
              <span className="text-5xl font-bold text-black tabular-nums">₹800</span>
            ...
            <button className="w-full bg-black hover:bg-neutral-800 text-white rounded-full h-12 font-semibold transition-[background-color,transform] active:scale-[0.96]">
              Get started
            </button>
          ...
          {/* Team Card */}
          <div className="flex flex-col p-5 md:p-8 rounded-2xl md:rounded-3xl bg-white border border-black/10 gap-4 md:gap-6">
            <div>
              <div className="flex items-center gap-2 mb-1">
                <h3 className="text-2xl font-bold text-black">Team</h3>
              </div>
              <p className="text-[15px] text-[#a1a1aa]">For teams & agencies</p>
            </div>
            
            <div className="flex gap-2 items-center">
              <span className="text-5xl font-bold text-black tabular-nums">₹960</span>
              <div className="flex flex-col">
            ...
            <button className="w-full bg-transparent border border-black/20 hover:bg-black/5 text-black rounded-full h-12 font-semibold transition-[background-color,transform] active:scale-[0.96]">
              Get started
            </button>
        ...
        <div className="flex flex-col md:flex-row gap-6 md:gap-24 w-full max-w-[800px] mb-10 md:mb-32 justify-center">
           <div className="flex flex-col items-center gap-2 text-center flex-1">
              ...
              <h4 className="font-bold text-black text-[17px]">Enterprise</h4>
              ...
              <a href="#" className="text-[15px] font-semibold text-gray-800 underline mt-2 hover:text-black transition-colors">Contact Sales</a>
           </div>
           <div className="flex flex-col items-center gap-2 text-center flex-1">
              <div className="w-12 h-12 rounded-xl bg-[#27272a] flex items-center justify-center mb-2">
              ...
              <h4 className="font-bold text-black text-[17px]">Startup founder?</h4>
              ...
              <a href="#" className="text-[15px] font-semibold text-gray-800 underline mt-2 hover:text-black transition-colors">Read more</a>
           </div>
        </div>

        {/* Table w/ Dark Theme */}
        <div className="w-full max-w-[1000px] mb-32 hidden md:block">
          <h2 className="text-4xl font-bold tracking-[-0.02em] text-black mb-12">Compare plans & features</h2>
          <div className="w-full overflow-hidden">
             <table className="w-full text-left border-collapse">
               <thead>
                 <tr>
                   <th className="w-2/5 p-4 pl-0 text-[17px] font-bold text-black border-b border-black/10">Content</th>
                   <th className="w-1/5 p-4 text-[17px] font-bold text-black border-b border-black/10">Free</th>
                   <th className="w-1/5 p-4 text-[17px] font-bold text-black border-b border-neutral-200 bg-neutral-50 rounded-t-2xl">Pro</th>
                   <th className="w-1/5 p-4 text-[17px] font-bold text-black border-b border-black/10">Team</th>
                 </tr>
               </thead>
               <tbody>
                 <tr className="border-b border-black/10">
                   <td className="p-4 pl-0 text-[15px] font-semibold text-black">Components</td>
                   <td className="p-4 text-[15px] text-[#a1a1aa]">Latest 20</td>
                   <td className="p-4 bg-neutral-50 text-black"><CheckIcon /></td>
                   <td className="p-4 text-black"><CheckIcon /></td>
                 </tr>
                 <tr className="border-b border-black/10">
                   <td className="p-4 pl-0 text-[15px] font-semibold text-black">Templates</td>
                   <td className="p-4 text-[15px] text-[#a1a1aa]">Latest 2</td>
                   <td className="p-4 bg-neutral-50 text-black"><CheckIcon /></td>
                   <td className="p-4 text-black"><CheckIcon /></td>
                 </tr>
                 <tr className="border-b border-black/10">
                   <td className="p-4 pl-0 text-[15px] font-semibold text-black">Pages</td>
                   <td className="p-4 text-[15px] text-[#a1a1aa]">Limited</td>
                   <td className="p-4 bg-neutral-50 text-black"><CheckIcon /></td>
                   <td className="p-4 text-black"><CheckIcon /></td>
                 </tr>
                 <tr className="border-b border-black/10">
                   <td className="p-4 pl-0 text-[15px] font-semibold text-black">Projects</td>
                   <td className="p-4 text-[15px] text-[#a1a1aa]">Up to 3</td>
                   <td className="p-4 bg-neutral-50 text-[15px] text-black">Unlimited</td>
                   <td className="p-4 text-[15px] text-black">Unlimited</td>
                 </tr>
               </tbody>
             </table>
          </div>
        ...
        <div className="w-full max-w-[800px] mb-12">
          <h2 className="text-4xl font-bold tracking-[-0.02em] text-black mb-12 text-center">Frequently asked questions</h2>
          <div className="flex flex-col gap-4">
            {faqs.map((faq, i) => {
              const [isOpen, setIsOpen] = useState(false);
              return (
                <div key={i} className="bg-neutral-50 hover:bg-neutral-100 transition-colors rounded-2xl cursor-pointer flex flex-col group overflow-hidden border border-black/5" onClick={() => setIsOpen(!isOpen)}>
                   <div className="p-6 flex justify-between items-center">
                     <h3 className="font-semibold text-black text-[17px]">{faq.question}</h3>
                     <motion.div animate={{ rotate: isOpen ? 180 : 0 }}>
                       <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none" className="text-neutral-400 group-hover:text-black transition-colors">
