...
import { UNIVERSAL_DELAY } from "../../lib/animationsdev/animations";
import { useAmbientAnimations } from "../../lib/animationsdev/hooks/use-ambient-animations";
import { useAnimateVariant } from "../../lib/animationsdev/hooks/use-animate-variant";
import { useHoverTimeout } from "../../lib/animationsdev/hooks/use-hover-timeout";
import { useMobileTap } from "../../lib/animationsdev/hooks/use-mobile-tap";
import {
  backgroundVariants,
  DURATION,
  handVariants,
  ...
  lineVariants,
  REPEAT_DELAY,
} from "../../lib/animationsdev/variants/click-variants";
import {
    ...
    >
      <g ref={floatingRef} className="will-change-transform">
        ...
        >
          <g
            ref={rotationRef}
            className="filter-[url(#filter4_i_359_1453)] dark:filter-[url(#filter4_i_368_1560)] will-change-transform"
          >
            <path
