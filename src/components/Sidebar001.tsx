    ...
    <div className="relative">
      ...
      >
        <a
          ...
          className={cn(
            "relative flex items-center gap-2 ml-2 pl-4 py-1.5 text-sm select-none rounded-full transition-colors",
...
export function Sidebar001Content({
  ...
  return (
    <div className="relative flex-1 overflow-hidden">
      <div
        className={cn("h-full overflow-y-auto py-4", className)}
      ...
      <ProgressiveBlur position="bottom" height="80px" />
    </div>
  );
}
