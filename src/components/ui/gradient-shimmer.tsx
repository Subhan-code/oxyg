/**
 * GradientShimmer — ported from https://github.com/BIAsia/gradient-shimmer
 * MIT License · zero runtime dependencies · Web-Animations-API driven
 *
 * Sweeps a multi-stop gradient highlight across text.
 * Pauses off-screen, during scroll, and under prefers-reduced-motion.
 */

"use client"

import { createElement, type CSSProperties, type ElementType, type HTMLAttributes, useEffect, useMemo, useRef } from "react"
...
export interface GradientShimmerProps extends Omit<HTMLAttributes<HTMLElement>, "children"> {
  ...
  easing?: EasingPreset
  /** Sweep speed in seconds. Defaults to `1.45`. */
  duration?: number
 ...
 *
 * @example
 * <GradientShimmer gradient="sunrise">Build faster.</GradientShimmer>
 * <GradientShimmer gradient="mint" easing="gentle" duration={2}>Premium components.</GradientShimmer>
 */
