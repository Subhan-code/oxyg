...
export default function Page() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0c] text-white pt-24 pb-20 px-6 sm:px-12 relative overflow-hidden font-sans">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <a 
          href="#/" 
          className="inline-flex items-center gap-2 text-zinc-400 hover:text-white transition-colors mb-12 text-sm font-medium group"
        >
        ...
        <div className="mb-16">
          ...
          <h1 className="text-4xl sm:text-6xl font-black tracking-tight text-white mt-6 mb-4">
        ...
        <div className="space-y-12">
          ...
          {/* Step 1 */}
          <div className="bg-zinc-900/40 border border-zinc-800/80 rounded-3xl p-6 sm:p-8 backdrop-blur-md">
            <div className="flex items-center gap-4 mb-6">
              ...
              <h2 className="text-xl sm:text-2xl font-bold tracking-tight text-white">Install Core Dependencies</h2>
            </div>
            ...
            <div className="relative bg-[#0d0e12] rounded-2xl border border-zinc-800 overflow-hidden group">
              <div className="flex items-center justify-between px-4 py-3 bg-[#13151a] border-b border-zinc-800 text-xs text-zinc-500 font-mono">
              ...
              <pre className="p-4 sm:p-5 overflow-x-auto text-xs sm:text-sm font-mono text-zinc-300 leading-normal">
          ...
          <div className="bg-zinc-900/40 border border-zinc-800/80 rounded-3xl p-6 sm:p-8 backdrop-blur-md">
            <div className="flex items-center gap-4 mb-6">
              ...
              <h2 className="text-xl sm:text-2xl font-bold tracking-tight text-white">Tailwind CSS v4 Configuration</h2>
            </div>
            <p className="text-zinc-400 text-sm sm:text-base mb-6 leading-relaxed">
          ...
          <div className="bg-zinc-900/40 border border-zinc-800/80 rounded-3xl p-6 sm:p-8 backdrop-blur-md">
            <div className="flex items-center gap-4 mb-6">
              ...
              <h2 className="text-xl sm:text-2xl font-bold tracking-tight text-white">Import & Use Components</h2>
            </div>
            <p className="text-zinc-400 text-sm sm:text-base mb-6 leading-relaxed">
          ...
          {/* AI-Ready Section */}
          <div className="bg-gradient-to-r from-blue-950/20 to-purple-950/20 border border-blue-900/40 rounded-3xl p-6 sm:p-8 backdrop-blur-md flex flex-col md:flex-row items-start gap-6">
            <div className="p-3 bg-blue-500/10 border border-blue-500/20 rounded-2xl text-blue-400 shrink-0">
              <Cpu className="w-6 h-6 animate-pulse" />
            </div>
            <div>
              <h3 className="text-lg sm:text-xl font-bold tracking-tight text-white mb-2">AI Agent Integration</h3>
