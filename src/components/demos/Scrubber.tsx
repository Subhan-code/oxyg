  ...
  return (
    <div className={cn("relative w-full select-none", className)}>
      <div
        ...
        className="relative cursor-pointer overflow-hidden bg-neutral-100 dark:bg-neutral-900 border border-neutral-200/50 dark:border-white/5 outline-offset-2"
      ...
      >
        {/* Fill indicator */}
        <div
          className="pointer-events-none absolute inset-y-0 left-0 bg-neutral-900/5 dark:bg-white/5"
          style={{
            borderRadius: 12,
            width: `${percentage}%`,
        ...
        {ticks > 0 && (
          <div className="pointer-events-none absolute inset-0">
            {Array.from({ length: ticks }, (_, i) => {
              ...
              return (
                <div
                  className="absolute top-1/2 bg-neutral-400/20 dark:bg-white/10"
                  key={pos}
                  style={{
                    left: `${pos}%`,
                    width: 1,
        ...
        >
          <motion.div
            ...
            className="bg-neutral-800 dark:bg-white/80"
            style={{
              width: 5,
              height: 34,
              borderRadius: 999,
        ...
        {/* Label */}
        <div
          className="pointer-events-none absolute top-1/2 left-[18px] -translate-y-1/2 whitespace-nowrap text-neutral-800 dark:text-neutral-200 font-semibold"
          style={{
            fontSize: 15,
            zIndex: 4,
          }}
        ...
        {/* Value display */}
        <div
          className="pointer-events-none absolute top-1/2 right-[14px] -translate-y-1/2 text-neutral-800 dark:text-neutral-200"
          style={{
            zIndex: 4,
